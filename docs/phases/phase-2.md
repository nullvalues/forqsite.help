...
| ID | Title | Status |
|----|-------|--------|
| CONTENT-001 | Consistency fixes: correct index.html/gap-handoff.html drift vs forqsite source (C1-C13) | draft |
| CONTENT-002 | Embellishments: add repo-grounded detail missing from the docs (E1-E8) | draft |
| CONTENT-003 | UX fixes: hash routing, scroll reset, responsive layout, deep links, clipboard fallback (U1-U10) | draft |
